...
if( ! class_exists( 'Businessx_Extensions_Features_Item' ) ) {
	class Businessx_Extensions_Features_Item extends Businessx_Extensions_Base {
		...
		public function widget( $args, $instance ) {
			...
			$allowed_html = apply_filters( 'businessx_extensions_features_item___allowed_html', $allowed_html = $this->allowed_html ); set_query_var( 'allowed_html', $allowed_html );
            ...
            <div class="bx-widget-tabs bx-bs">
                ...
                <div class="bx-wt-tab-wrap bx-bs">
                    ...
                    <div class="bx-wt-tab-contents bx-bs">
						...
						parent::text_input( $btn_url, 'btn_url', __( 'URL:', 'businessx-extensions' ), 'url', '', __( 'E.g: http://www.google.com', 'businessx-extensions' ) );
