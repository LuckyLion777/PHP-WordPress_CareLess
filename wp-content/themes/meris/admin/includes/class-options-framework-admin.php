...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', MERIS_OPTIONS_FRAMEWORK_URI . 'css/optionsframework.css', array(),  Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', MERIS_OPTIONS_FRAMEWORK_URI . 'js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION ,true);
		wp_enqueue_script( 'options-tooltip', MERIS_OPTIONS_FRAMEWORK_URI . 'js/bootstrap-tooltip.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION ,true);
		wp_enqueue_script( 'options-confirmation', MERIS_OPTIONS_FRAMEWORK_URI . 'js/bootstrap-confirmation.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION ,true);
